...
{
  imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Software/Application Development.webp`,
  title: "Application Development",
  link: "/Service/Software/ApplicationDevelopment"
},
{
  imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Software/Software testing.webp`,
  title: "Software Testing",
  link: "/Service/Software/SoftwareTesting"
},
{
  imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Software/Cloud.webp`,
  title: "Cloud",
  link: "/Service/Software/Cloud"
},
{
  imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Software/PLM .webp`,
  title: "PLM",
  ...
  return (
    <div>
      ...
      <div aria-label='our-service-offerings' className='w-full py-24 bg-cyan-600'>
        ...
        <div className=' mt-24 w-full flex justify-center flex-wrap gap-24'>
      ...
      {/* <div aria-label="discover more section" className={`w-full bg-cyan-700 py-24 bg-[url('${import.meta.env.VITE_REACT_APP_API_URL}/cube-background.webp')]`}>
