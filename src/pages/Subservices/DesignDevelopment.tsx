...
const TrendingTechnologiesData = [
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/6.svg`,
    },
    {
        heading: "Simulation and Finite Element Analysis (FEA)",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/7.svg`,
    },
    {
        heading: "Internet of Things (IoT) Integration",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/8.svg`,
    },
    {
        heading: "Augmented Reality (AR) and Virtual Reality (VR)",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/9.svg`,
    },
    {
        heading: "Digital Twins",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/10.svg`,
    }
];
...
const ServiceOfferings = [
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/1.svg`,
    },
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/2.svg`,
    },
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/3.svg`,
    },
    {
        heading: "Rapid Prototyping",
        description: " Transform concepts into reality with our rapid prototyping services. We utilize state-of-the-art technologies to fabricate prototypes quickly and efficiently, enabling iterative design processes and accelerating product development cycles.",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/4.svg`,
    },
    {
        heading: "Design for Manufacturing (DFM)",
        description: "Optimize manufacturability with our Design for Manufacturing (DFM) services. We analyze designs to identify opportunities for cost reduction, process optimization, and quality enhancement, ensuring seamless transition from design to production.",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/5.svg`,
    }
];
        ...
        <div>
            <div aria-label='landing-image' className="w-full aspect-video relative">
                ...
                <video  
                  ...
                  muted
                >
                  <source src={`${import.meta.env.VITE_REACT_APP_API_URL}/Services/Mechanical/Design & Development/Landing.mp4`} type="video/mp4" />
                </video>
            ...
            <div aria-label='what-we-do' className='w-full py-24'>
                <div>
                    ...
                    In recent years, technological progress has surged at an unprecedented rate, outpacing the ability of end users to fully grasp its implications. This trend is poised to continue into the next decade, with advancements accelerating beyond the comprehension of the average individual. In such a rapidly evolving landscape, the imperative for design is clear: to humanize technology and safeguard the interests of end users.In this context, the role of design extends far beyond mere functionality. It encompasses the imperative to delight consumers, educate children, enhance office productivity, bolster system security, and navigate the complexities of artificial intelligence usage, among other vital functions.        </p>
                    <br />
                    
                    <p className='container text-3xl mx-auto px-8 text-gray-600'>
                    The user-centric approach of design thinking facilitates a profound understanding of all stakeholders involved, while expertise in pertinent technologies enables the development of tailored solutions. This fusion of technology-driven innovation guided by design thinking principles holds the promise of a brighter, more prosperous future for all. Ultimately, by harnessing the power of design to navigate the complexities of technological advancement, we can ensure a future characterized by both innovation and human-centricity.        </p>
                </div>
            </div>
