...
const TrendingTechnologiesData = [
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/5G.jpg`,
    },
    {
        heading: "Edge Computing",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/Edge.jpg`,
    },
    {
        heading: "AI/ML",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/34.svg`,
    },
    {
        heading: "Blockchain Technology",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/35.svg`,
    },
    {
        heading: "LPWAN(Low-Power Wide-Area Network",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/36.svg`,
    },
    {
        heading: "Digital Twins",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/37.svg`,
    }
];
...
const ServiceOfferings = [
    ...
    },
    {
        ...
        description: " Security is paramount in the IoT landscape, and we prioritize the implementation of robust security measures to safeguard your IoT deployments against potential threats and vulnerabilities. Our comprehensive security and compliance services ensure your IoT solutions adhere to industry standards and regulatory requirements. ",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Industries/LifeSciences/Quality.svg`,
    },
    {
        heading: "IoT Strategy and Consulting",
        description: "Let's work together to develop a cohesive strategy with our clients, aimed at driving business transformation through IoT. Our approach involves several key steps: assessing organizational readiness, analyzing business scenarios, calculating ROI, devising a technology roadmap, outlining architectural blueprints, crafting deployment plans, and selecting suitable partners. We're here to streamline and enhance your IoT journey, ensuring smooth implementation and meaningful outcomes.",
        link: "",
        ...
        <div>
            <div aria-label='landing-image' className="w-full aspect-video relative">
                ...
                >
                    <div className="md:w-2/3 h-full flex justify-start items-center p-24">
                        <div aria-label="content" className="md:text-left">
                            ...
                            Transforming Data into Action: Saraca's IoT Engineering Expertise 
                            </p>
                ...
                <video  
                  ...
                  muted
                >
                  <source src={`${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/IOT/landing.mp4`} type="video/mp4" />
                </video>  
            ...
            <div aria-label='what-we-do' className='w-full py-24'>
                <div>
                    ...
                    In today's digital landscape, IoT (Internet of Things) engineering stands at the forefront of innovation, enabling seamless connectivity and intelligent automation across diverse industries. At Saraca, we recognize the transformative power of IoT engineering in driving efficiency, optimizing operations, and delivering unparalleled user experiences. IoT engineering serves as the backbone of modern digital ecosystems, empowering businesses to harness real-time data insights, automate processes, and unlock new revenue streams. At Saraca, we ensure the reliability, scalability, and security of IoT solutions, enabling organizations to thrive in the era of digital transformation.</p>
                </div>
            </div>
