...
const TrendingTechnologiesData = [
  {
    ...
    }/Services/Mechanical/CADCAM/5.webp`,
  },
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/6.webp`,
  },
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/7.webp`,
  },
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/8.webp`,
  },
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/9.webp`,
  },
];
...
const ServiceOfferings = [
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/1.webp`,
  },
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/2.webp`,
  },
  {
    ...
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/3.webp`,
  },
  {
    heading: "CAM Programming and Optimization",
    description:
      " Optimize manufacturing processes and enhance CNC machining capabilities with our CAM programming and optimization services, maximizing throughput and quality while minimizing production costs.",
    link: "",
    imageSrc: `${
      import.meta.env.VITE_REACT_APP_API_URL
    }/Services/Mechanical/CADCAM/4.webp`,
  },
];
...
const Industry = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>
        CAD, CAE, CFD, CAM Services | Design and Manufacturing Solutions | Saraca
        </title>
        <meta
          property="og:title"
          content="CAD, CAE, CFD, CAM Services | Design and Manufacturing Solutions | Saraca"
        />
        <meta
          name="description"
          content="Explore Saraca's CAD, CAE, CFD, and CAM services for comprehensive design and manufacturing solutions. From concept design and validation to manufacturing process optimization, leverage advanced technologies like generative design, additive manufacturing, and digital twins for innovation and efficiency"
        />
        <meta
          name="keywords"
          content="CAD services, CAE solutions, CFD simulations, CAM programming, generative design, additive manufacturing, digital twins, AR for design visualization, cloud-based simulation tools"
        />
        <meta
      ...
      <div aria-label="landing-image" className=" aspect-video w-full relative">
        ...
        >
          <source
            src={`${
              import.meta.env.VITE_REACT_APP_API_URL
            }/Services/Mechanical/CADCAM/Landing.mp4`}
            type="video/mp4"
          />
        </video>
      </div>
      <div aria-label="what-we-do" className="w-full py-24">
        <div>
          ...
          <p className="container text-3xl mx-auto px-8 text-gray-600 mt-24">
            CAD plays a crucial role in the product development lifecycle, from
            initial concept design to manufacturing and assembly. It helps
            streamline workflows, reduce errors, and accelerate time-to-market
            for new products. Additionally, CAD software integrates with other
            engineering tools and technologies, such as CAE (Computer-Aided
            Engineering) and CAM (Computer-Aided Manufacturing), to create a
            comprehensive solution for design, analysis, and production.{" "}
          </p>
          <br />

          <p className="container text-3xl mx-auto px-8 text-gray-600">
            CFD stands for Computational Fluid Dynamics. It is a branch of fluid
            mechanics that utilizes numerical methods and algorithms to analyze
            and solve problems involving fluid flow and heat transfer phenomena.
            CFD simulations are performed using specialized software that
            divides the fluid domain into a grid of discrete elements, allowing
            for the numerical solution of governing equations that describe
            fluid behavior.{" "}
          </p>
          <br />

          <p className="container text-3xl mx-auto px-8 text-gray-600">
            CAM stands for Computer-Aided Manufacturing. It is a technology that
            utilizes computer software and numerical control machinery to
            automate and control manufacturing processes. CAM software enables
            the conversion of digital design data (such as CAD models) into
            instructions that drive machine tools and equipment, facilitating
            the production of physical components or parts with precision and
            efficiency.{" "}
          </p>
          <br />

          <p className="container text-3xl mx-auto px-8 text-gray-600">
            CAE stands for Computer-Aided Engineering. It is a broad term that
            refers to the use of computer software and simulation tools to
            assist engineers in the analysis, design, and optimization of
            engineering systems and components. CAE encompasses a range of
            disciplines and techniques aimed at simulating and evaluating the
            performance, behavior, and characteristics of complex systems in
