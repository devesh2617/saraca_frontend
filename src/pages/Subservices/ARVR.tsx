...
const Industry = () => {
    ...
    return (
        <div>
            ...
            <div aria-label="trending-technologies-section" className="min-h-[30vh] w-full bg-cyan-950 py-24 bg-[url('../../../public/trending-technologies-pattern.svg')] bg-cover">
            ...
            {/* <div aria-label="discover more section" className="min-h-[80vh] w-full bg-cyan-700 bg-[url('../../../public/cube-background.svg')] py-24">
