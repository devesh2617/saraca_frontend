...
const TrendingTechnologiesData = [
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/6.svg`,
    },
    {
        heading: "Continuous Integration and Continuous Testing (CI/CT)",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/7.svg`,
    },
    {
        heading: "Hardware-in-the-Loop (HIL) Testing",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/8.svg`,
    },
    {
        heading: "Artificial Intelligence (AI) and Machine Learning (ML) for Test Automation",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/9.svg`,
    },
    {
        heading: "Cybersecurity Testing for Embedded Systems",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/10.svg`,
    }
];
...
const ServiceOfferings = [
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/1.svg`,
    },
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/2.svg`,
    },
    {
        ...
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/3.svg`,
    },
    {
        heading: "Risk Assessment & Mitigation",
        description: " We conduct thorough risk assessments to identify potential vulnerabilities and develop proactive mitigation strategies, safeguarding against unforeseen challenges and minimizing project disruptions.",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/4.svg`,
    },
    {
        heading: "Compliance & Certification Support",
        description: "Our experienced team provides comprehensive support throughout the compliance and certification process, guiding clients through regulatory requirements and facilitating successful product approvals.",
        link: "",
        imageSrc: `${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/5.svg`,
    }
];
        ...
        <div>
            <div aria-label='landing-image' className=" aspect-video w-full relative">
                ...
                <video  
                  ...
                  muted
                >
                  <source src={`${import.meta.env.VITE_REACT_APP_API_URL}/Services/Embedded/V&V/Landing.mp4`} type="video/mp4" />
                </video>
            ...
            <div aria-label='what-we-do' className='w-full py-24'>
                <div>
                    ...
                    V&V (Verification and Validation) engineering in the embedded sector refers to the process of ensuring that embedded systems, which are computer systems embedded within larger mechanical or electrical systems, meet their intended specifications and requirements. Overall, V&V engineering in the embedded sector is essential for ensuring the quality, reliability, and safety of embedded systems across various industries, including automotive, aerospace, medical devices, consumer electronics, and industrial automation.        </p>
                    <br />
