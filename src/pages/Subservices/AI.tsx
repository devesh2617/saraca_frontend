        ...
        <div>
            <div aria-label='landing-image' className="w-full aspect-video relative">
                ...
                <video  
                  ...
                  muted
                >
                  <source src={`${import.meta.env.VITE_REACT_APP_API_URL}/Services/Digital/AI/landing.mp4`} type="video/mp4" />
                </video> 
            ...
            <div aria-label='what-we-do' className='w-full py-24'>
                <div>
                    ...
                    At Saraca, we recognize the profound impact of AI engineering in shaping the digital landscape and driving transformative change. In today's digital ecosystem, AI serves as a catalyst for innovation, enabling businesses to automate processes, gain actionable insights, and deliver personalized experiences at scale. AI engineering ensures the reliability, efficiency, and intelligence of digital solutions, empowering organizations to stay competitive in a rapidly evolving market.        </p>
                </div>
            </div>
