...
const Card: FC<CardProps> = ({ cardsData, imageSrc }) => {
  return (
    <div
      className={`subgrid container mx-auto bg-gradient-to-l from-slate-700 to-slate-400 px-8 rounded-xl sm:min-h-24 shadow-md transition-all duration-500 py-8`}
    >
