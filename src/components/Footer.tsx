const Footer = () => {
  ...
  return (
    <div aria-label="footer" className="mt-auto">
      ...
      <div aria-label="privacy-notice" className="bg-black min-h-36 text-white flex items-center">
        <div className="container flex items-center justify-between flex-col md:flex-row gap-8 p-8">
        <img src={`${import.meta.env.VITE_REACT_APP_API_URL}/saraca-logo.svg`} alt="" className="h-12 object-contain" />
        <div>
