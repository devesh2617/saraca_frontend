const Footer = () => {
  ...
  return (
    <div
        aria-label="footer"
        className={`max-w-full text-sky-200 min-h-[35vh] bg-[url('${import.meta.env.VITE_REACT_APP_API_URL}/footer.webp')] bg-cover mx-auto flex-col flex sm:flex-col md:flex-row mt-auto leading-relaxed bg-black`}
