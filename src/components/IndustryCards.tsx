...
const IndustryCards:FC<medicalCardsData> = (props) => {
  return (
    ...
    <div className={`bg-white absolute z-1 top-[85%] w-full h-full text-2xl text-center text-cyan-700  translate-all duration-500 ${props.points.length?"group-hover:bg-opacity-80 group-hover:top-0":""} p-2`}>
